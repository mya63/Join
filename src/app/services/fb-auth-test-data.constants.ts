...
export const TEST_CONTACTS: readonly TestContactTemplate[] = [
  { key: 'tc-01', name: 'Liam', surname: 'Carter', email: 'liam.carter@join.local', phone: '+4915190000001', color: '#FF7A00' },
  { key: 'tc-02', name: 'Emma', surname: 'Fischer', email: 'emma.fischer@join.local', phone: '+4915190000002', color: '#9327FF' },
  { key: 'tc-03', name: 'Noah', surname: 'Becker', email: 'noah.becker@join.local', phone: '+4915190000003', color: '#6E52FF' },
  { key: 'tc-04', name: 'Mia', surname: 'Wagner', email: 'mia.wagner@join.local', phone: '+4915190000004', color: '#FC71FF' },
  { key: 'tc-05', name: 'Elias', surname: 'Schmidt', email: 'elias.schmidt@join.local', phone: '+4915190000005', color: '#FFBB2B' },
  { key: 'tc-06', name: 'Sofia', surname: 'Keller', email: 'sofia.keller@join.local', phone: '+4915190000006', color: '#1FD7C1' },
  { key: 'tc-07', name: 'Jonas', surname: 'Hartmann', email: 'jonas.hartmann@join.local', phone: '+4915190000007', color: '#462F8A' },
  { key: 'tc-08', name: 'Lina', surname: 'Krause', email: 'lina.krause@join.local', phone: '+4915190000008', color: '#FF4646' },
  { key: 'tc-09', name: 'Finn', surname: 'Neumann', email: 'finn.neumann@join.local', phone: '+4915190000009', color: '#00BEE8' },
  { key: 'tc-10', name: 'Hannah', surname: 'Wolf', email: 'hannah.wolf@join.local', phone: '+4915190000010', color: '#FF5EC4' }
];
